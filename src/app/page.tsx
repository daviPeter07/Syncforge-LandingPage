...
export default function App() {
  return (
    <main className="flex min-h-svh items-center justify-center bg-[linear-gradient(180deg,#000000_0%,#00030f_30%,#00072D_100%)] px-6 py-16 text-white">
      <section className="mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        <h1 className="mt-4 max-w-3xl text-3xl leading-[1.05] font-semibold tracking-tighter sm:text-5xl lg:text-[4rem]">
          Nosso site esta em construção.
        </h1>

        <p className="mt-7 max-w-xl text-sm leading-7 text-white/68 sm:text-base">
          A SyncForge oferece serviços digitais para empresas e pessoas físicas,
          com soluções desenvolvidas de acordo com cada necessidade.
        </p>
